								...
								<form action="<c:url value='/project/add'/>" method="post">
									<div class="row">
										<div class="col-12 mt-3">
											<input type="hidden" value="1" name="leader">
			...
			<tbody>
				<c:forEach var="item" items="${PROJECTS}">
					<tr>
						...
						<td>${item.endDate}</td>
						<td><a href="<c:url value='/project-user?' />">Xem danh
								sách </a></td>
						<td><a href="<c:url value='/project/edit?id=${item.id}'/>"
							class="btn btn-sm btn-info"> <i class="fa fa-pencil-square-o"></i>
						</a> <a href="<c:url value='/project/remove'/>"
